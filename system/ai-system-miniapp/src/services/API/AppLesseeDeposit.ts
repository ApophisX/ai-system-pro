...
export async function AppLesseeDepositControllerQueryDepositsV1(
  ...
  return request<MyApi.ApiResponseOutputDepositDtoArray>('/api/v1/app/deposit/lessee', {
    method: 'GET',
    params: {
...
export async function AppLesseeDepositControllerGetDepositByIdV1(
  ...
  return request<MyApi.ApiResponseOutputDepositDto>(`/api/v1/app/deposit/lessee/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  });
...
export async function AppLesseeDepositControllerGetDeductionsV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseOutputDepositDtoArray>(`/api/v1/app/deposit/lessee/${param0}/deductions`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  });
...
export async function AppLesseeDepositControllerGetDepositByOrderIdV1(
  ...
  return request<MyApi.ApiResponseOutputDepositDto>(`/api/v1/app/deposit/lessee/order/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  });
...
export async function AppLesseeDepositControllerGetDepositSummaryV1(options?: { [key: string]: any }) {
  return request<MyApi.ApiResponseOutputLesseeDepositSummaryDto>('/api/v1/app/deposit/lessee/summary', {
    method: 'GET',
    ...(options || {}),
  });
}
