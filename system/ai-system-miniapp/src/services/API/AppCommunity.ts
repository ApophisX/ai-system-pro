...
export async function AppCommunityControllerGetListV1(
  ...
  return request<MyApi.ApiResponseOutputCommunityListItemDtoArray>('/api/v1/app/communities', {
    method: 'GET',
    params: {
...
export async function AppCommunityControllerCreateV1(body: MyApi.CreateCommunityDto, options?: { [key: string]: any }) {
  return request<MyApi.ApiResponseOutputCommunityDto>('/api/v1/app/communities', {
    method: 'POST',
    headers: {
...
export async function AppCommunityControllerGetDetailV1(
  ...
  return request<MyApi.ApiResponseOutputCommunityDto>(`/api/v1/app/communities/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  });
...
export async function AppCommunityControllerDeleteV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseBoolean>(`/api/v1/app/communities/${param0}`, {
    method: 'DELETE',
    params: { ...queryParams },
    ...(options || {}),
  });
...
export async function AppCommunityControllerResetInviteCodeV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseOutputCommunityDto>(`/api/v1/app/communities/${param0}/reset-invite-code`, {
    method: 'POST',
    params: { ...queryParams },
    ...(options || {}),
  });
...
export async function AppCommunityControllerGetMyCreatedV1(
  ...
  return request<MyApi.ApiResponseOutputCommunityDtoArray>('/api/v1/app/communities/created', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function AppCommunityControllerGetMyJoinedV1(
  ...
  return request<MyApi.ApiResponseOutputCommunityListItemDtoArray>('/api/v1/app/communities/my', {
    method: 'GET',
    params: {
      // pageSize has a default value: 20
      pageSize: '20',
