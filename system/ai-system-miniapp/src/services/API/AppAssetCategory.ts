...
export async function AppAssetCategoryControllerGetCategoriesV1(
  ...
  return request<MyApi.ApiResponseAppOutputAssetCategoryDtoArray>('/api/v1/app/asset-categories', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function AppAssetCategoryControllerGetChildCategoriesV1(
  ...
  return request<MyApi.ApiResponseAppOutputAssetCategoryDtoArray>(`/api/v1/app/asset-categories/${param0}/children`, {
    method: 'GET',
    params: {
      ...queryParams,
    },
...
export async function AppAssetCategoryControllerGetCategoryByCodeV1(
  ...
  return request<MyApi.ApiResponseAppOutputAssetCategoryDto>(`/api/v1/app/asset-categories/code/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  });
...
export async function AppAssetCategoryControllerGetCategoryTreeV1(options?: { [key: string]: any }) {
  return request<MyApi.ApiResponseAppOutputAssetCategoryTreeDtoArray>('/api/v1/app/asset-categories/tree', {
    method: 'GET',
    ...(options || {}),
  });
}
