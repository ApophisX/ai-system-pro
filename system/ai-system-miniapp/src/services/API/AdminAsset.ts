...
export async function AdminAssetControllerGetListV1(
  ...
  return request<MyApi.ApiResponseOutputAssetAdminListItemDtoArray>('/api/v1/admin/assets', {
    method: 'GET',
    params: {
...
export async function AdminAssetControllerGetByIdV1(
  ...
  return request<MyApi.ApiResponseOutputAssetAdminDetailDto>(`/api/v1/admin/assets/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  });
...
export async function AdminAssetControllerAuditV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseOutputAssetAdminDetailDto>(`/api/v1/admin/assets/${param0}/audit`, {
    method: 'PUT',
    headers: {
...
export async function AdminAssetControllerForceOfflineV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseOutputAssetAdminDetailDto>(`/api/v1/admin/assets/${param0}/force-offline`, {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
    },
