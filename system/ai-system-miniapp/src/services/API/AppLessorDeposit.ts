...
export async function AppLessorDepositControllerQueryDepositsV1(
  ...
  return request<MyApi.ApiResponseOutputDepositDtoArray>('/api/v1/app/deposit/lessor', {
    method: 'GET',
    params: {
...
export async function AppLessorDepositControllerGetDepositByIdV1(
  ...
  return request<MyApi.ApiResponseOutputDepositDto>(`/api/v1/app/deposit/lessor/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  });
...
export async function AppLessorDepositControllerGetDeductionsV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseOutputDepositDtoArray>(`/api/v1/app/deposit/lessor/${param0}/deductions`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  });
...
export async function AppLessorDepositControllerGetDepositByOrderIdV1(
  ...
  return request<MyApi.ApiResponseOutputDepositDto>(`/api/v1/app/deposit/lessor/order/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  });
