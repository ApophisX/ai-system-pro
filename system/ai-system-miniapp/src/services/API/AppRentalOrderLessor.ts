...
export async function AppRentalOrderLessorControllerQueryOrdersV1(
  ...
  return request<MyApi.ApiResponseOutputRentalOrderDtoArray>('/api/v1/app/rental-order/lessor', {
    method: 'GET',
    params: {
...
export async function AppRentalOrderLessorControllerGetOrderByIdV1(
  ...
  return request<MyApi.ApiResponseOutputRentalOrderDto>(`/api/v1/app/rental-order/lessor/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  });
...
export async function AppRentalOrderLessorControllerApproveCancelOrderV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseOutputRentalOrderDto>(`/api/v1/app/rental-order/lessor/${param0}/approve-cancel`, {
    method: 'PUT',
    headers: {
...
export async function AppRentalOrderLessorControllerCancelByLessorOrderV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseOutputRentalOrderDto>(`/api/v1/app/rental-order/lessor/${param0}/cancel-by-lessor`, {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function AppRentalOrderLessorControllerConfirmReturnV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseOutputRentalOrderDto>(`/api/v1/app/rental-order/lessor/${param0}/confirm-return`, {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function AppRentalOrderLessorControllerDeductDepositV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseOutputRentalOrderDto>(`/api/v1/app/rental-order/lessor/${param0}/deduct-deposit`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function AppRentalOrderLessorControllerEndOrderV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseOutputRentalOrderDto>(`/api/v1/app/rental-order/lessor/${param0}/end-order`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function AppRentalOrderLessorControllerForceCloseOrderV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseOutputRentalOrderDto>(`/api/v1/app/rental-order/lessor/${param0}/force-close`, {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function AppRentalOrderLessorControllerRefundDepositV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseOutputRentalOrderDto>(`/api/v1/app/rental-order/lessor/${param0}/refund-deposit`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function AppRentalOrderLessorControllerSetOrderDiscountV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseOutputRentalOrderDto>(`/api/v1/app/rental-order/lessor/${param0}/set-discount`, {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function AppRentalOrderLessorControllerQueryPendingOrdersV1(
  ...
  return request<MyApi.ApiResponseOutputRentalOrderDto[]>('/api/v1/app/rental-order/lessor/pending', {
    method: 'GET',
    params: {
      // pageSize has a default value: 10
      pageSize: '10',
