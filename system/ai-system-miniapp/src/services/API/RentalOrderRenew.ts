...
export async function RentalOrderRenewControllerPayRenewalV1(
  ...
  return request<MyApi.ApiResponseOutputPayRentalOrderResultDto>(`/api/v1/app/rental-order/${param0}/pay-renewal`, {
    method: 'POST',
    headers: {
...
export async function RentalOrderRenewControllerRenewV1(
  ...
  const { orderId: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseOutputRentalOrderDto>(`/api/v1/app/rental-order/${param0}/renew`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function RentalOrderRenewControllerRenewPreviewV1(
  ...
  const { orderId: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseRenewPreviewDto>(`/api/v1/app/rental-order/${param0}/renew-preview`, {
    method: 'GET',
    params: {
      ...queryParams,
    },
