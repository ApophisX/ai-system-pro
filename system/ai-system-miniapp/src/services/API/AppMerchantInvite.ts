...
export async function AppMerchantInviteControllerGetMyInviteCodeV1(options?: { [key: string]: any }) {
  return request<MyApi.ApiResponseOutputMyInviteCodeDto>('/api/v1/app/merchant-invite/my/code', {
    method: 'GET',
    ...(options || {}),
  });
}
...
export async function AppMerchantInviteControllerGetMyInvitationsV1(
  ...
  return request<MyApi.ApiResponseOutputMerchantInviteRelationDtoArray>('/api/v1/app/merchant-invite/my/invitations', {
    method: 'GET',
    params: {
...
export async function AppMerchantInviteControllerGetMyRewardsV1(
  ...
  return request<MyApi.ApiResponseOutputMerchantInviteRewardDtoArray>('/api/v1/app/merchant-invite/my/rewards', {
    method: 'GET',
    params: {
      // pageSize has a default value: 10
      pageSize: '10',
...
export async function AppMerchantInviteControllerGetRankV1(
  ...
  return request<MyApi.ApiResponseOutputInviteRankItemDtoArray>('/api/v1/app/merchant-invite/rank', {
    method: 'GET',
    params: {
