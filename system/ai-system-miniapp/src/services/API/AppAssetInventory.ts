...
export async function AppAssetInventoryControllerGetListV1(
  ...
  return request<MyApi.ApiResponseOutputAssetInventoryDtoArray>('/api/v1/app/asset-inventory', {
    method: 'GET',
    params: {
...
export async function AppAssetInventoryControllerGetByIdV1(
  ...
  return request<MyApi.ApiResponseOutputAssetInventoryDto>(`/api/v1/app/asset-inventory/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  });
...
export async function AppAssetInventoryControllerDeleteV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseBoolean>(`/api/v1/app/asset-inventory/${param0}`, {
    method: 'DELETE',
    params: { ...queryParams },
    ...(options || {}),
  });
...
export async function AppAssetInventoryControllerForceUnbindV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseBoolean>(`/api/v1/app/asset-inventory/${param0}/force-unbind`, {
    method: 'PUT',
    params: { ...queryParams },
    ...(options || {}),
  });
...
export async function AppAssetInventoryControllerGetByAssetIdV1(
  ...
  return request<MyApi.ApiResponseOutputAssetInventoryDtoArray>(`/api/v1/app/asset-inventory/asset/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  });
