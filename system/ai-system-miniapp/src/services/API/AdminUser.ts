...
export async function AdminUserControllerGetAdminUserListV1(
  ...
  return request<MyApi.ApiResponseOutputAdminUserListItemDtoArray>('/api/v1/admin/user', {
    method: 'GET',
    params: {
...
export async function AdminUserControllerGetAdminUserDetailV1(
  ...
  return request<MyApi.ApiResponseOutputUserDetailDto>(`/api/v1/admin/user/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  });
...
export async function AdminUserControllerUpdateAdminUserV1(
  ...
  const { userId: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseOutputUserDto>(`/api/v1/admin/user/${param0}`, {
    method: 'PUT',
    headers: {
...
export async function AdminUserControllerApproveEnterpriseVerificationV1(
  ...
  const { userId: param0, ...queryParams } = params;
  return request<any>(`/api/v1/admin/user/${param0}/enterprise-verification/approve`, {
    method: 'POST',
    params: { ...queryParams },
    ...(options || {}),
  });
...
export async function AdminUserControllerRejectEnterpriseVerificationV1(
  ...
  const { userId: param0, ...queryParams } = params;
  return request<any>(`/api/v1/admin/user/${param0}/enterprise-verification/reject`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function AdminUserControllerRevertEnterpriseVerificationToPendingV1(
  ...
  const { userId: param0, ...queryParams } = params;
  return request<any>(`/api/v1/admin/user/${param0}/enterprise-verification/revert-to-pending`, {
    method: 'POST',
    params: { ...queryParams },
    ...(options || {}),
  });
