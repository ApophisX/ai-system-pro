...
export async function AdminDepositDeductionControllerGetListV1(
  ...
  return request<MyApi.ApiResponseOutputDepositDeductionDtoArray>('/api/v1/admin/deposit-deductions', {
    method: 'GET',
    params: {
...
export async function AdminDepositDeductionControllerGetByIdV1(
  ...
  return request<MyApi.ApiResponseOutputDepositDeductionDto>(`/api/v1/admin/deposit-deductions/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  });
...
export async function AdminDepositDeductionControllerReviewV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseOutputDepositDeductionDto>(`/api/v1/admin/deposit-deductions/${param0}/review`, {
    method: 'PUT',
    headers: {
