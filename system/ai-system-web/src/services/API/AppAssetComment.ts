...
export async function AppAssetCommentControllerGetListV1(
  ...
  return request<MyApi.ApiResponseOutputAssetCommentDtoArray>(
    "/api/v1/app/asset-comment",
    {
      method: "GET",
      params: {
...
export async function AppAssetCommentControllerCreateV1(
  ...
  return request<MyApi.ApiResponseOutputAssetCommentDto>(
    "/api/v1/app/asset-comment",
    {
      method: "POST",
      headers: {
...
export async function AppAssetCommentControllerGetByIdV1(
  ...
  return request<MyApi.ApiResponseOutputAssetCommentDto>(
    `/api/v1/app/asset-comment/${param0}`,
    {
      method: "GET",
      params: { ...queryParams },
      ...(options || {}),
...
export async function AppAssetCommentControllerGetCommentCountByAssetIdV1(
  ...
  return request<MyApi.ApiResponseNumber>(
    `/api/v1/app/asset-comment/asset/${param0}/count`,
    {
      method: "GET",
      params: { ...queryParams },
      ...(options || {}),
