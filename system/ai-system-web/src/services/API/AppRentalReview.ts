...
export async function AppRentalReviewControllerGetListV1(
  ...
  return request<MyApi.ApiResponseOutputRentalReviewDtoArray>(
    "/api/v1/app/rental-review",
    {
      method: "GET",
      params: {
...
export async function AppRentalReviewControllerCreateV1(
  ...
  return request<MyApi.ApiResponseOutputRentalReviewDto>(
    "/api/v1/app/rental-review",
    {
      method: "POST",
      headers: {
...
export async function AppRentalReviewControllerReplyV1(
  ...
  return request<MyApi.ApiResponseBoolean>(
    `/api/v1/app/rental-review/${param0}/reply`,
    {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
...
export async function AppRentalReviewControllerGetSummaryV1(
  ...
  return request<MyApi.ApiResponseOutputRentalReviewSummaryDto>(
    `/api/v1/app/rental-review/asset/${param0}/summary`,
    {
      method: "GET",
      params: { ...queryParams },
      ...(options || {}),
