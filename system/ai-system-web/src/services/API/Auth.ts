...
export async function AuthControllerGetCurrentUserV1(options?: {
  [key: string]: any;
}) {
...
export async function AuthControllerRealNameAuthV1(
  body: MyApi.RealNameAuthDto,
  options?: { [key: string]: any }
) {
...
export async function AuthControllerSignInV1(
  body: MyApi.LoginDto,
  options?: { [key: string]: any }
) {
...
export async function AuthControllerSignUpV1(
  body: MyApi.RegisterDto,
  options?: { [key: string]: any }
) {
