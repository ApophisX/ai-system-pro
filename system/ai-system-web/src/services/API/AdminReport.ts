...
export async function AdminReportControllerGetListV1(
  ...
  return request<MyApi.ApiResponseOutputReportDtoArray>(
    "/api/v1/admin/report/specification",
    {
      method: "GET",
      params: {
...
export async function AdminReportControllerGetByIdV1(
  ...
  return request<MyApi.ApiResponseOutputReportDto>(
    `/api/v1/admin/report/specification/${param0}`,
    {
      method: "GET",
      params: { ...queryParams },
      ...(options || {}),
...
export async function AdminReportControllerHandleV1(
  ...
  return request<MyApi.ApiResponseBoolean>(
    `/api/v1/admin/report/specification/${param0}/handle`,
    {
      method: "PUT",
      headers: {
