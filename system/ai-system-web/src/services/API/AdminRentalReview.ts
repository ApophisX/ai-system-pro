...
export async function AdminRentalReviewControllerGetListV1(
  ...
  return request<MyApi.ApiResponseOutputRentalReviewAdminDtoArray>(
    "/api/v1/admin/rental-review",
    {
      method: "GET",
      params: {
...
export async function AdminRentalReviewControllerApproveV1(
  ...
  return request<MyApi.ApiResponseBoolean>(
    `/api/v1/admin/rental-review/${param0}/approve`,
    {
      method: "PUT",
      params: { ...queryParams },
      ...(options || {}),
...
export async function AdminRentalReviewControllerHideV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseBoolean>(
    `/api/v1/admin/rental-review/${param0}/hide`,
    {
      method: "PUT",
      params: { ...queryParams },
      ...(options || {}),
...
export async function AdminRentalReviewControllerRejectV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseBoolean>(
    `/api/v1/admin/rental-review/${param0}/reject`,
    {
      method: "PUT",
      headers: {
