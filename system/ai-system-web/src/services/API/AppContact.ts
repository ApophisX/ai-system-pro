...
export async function AppContactControllerGetMyContactsV1(
  ...
  return request<MyApi.ApiResponseOutputContactDtoArray>(
    "/api/v1/app/contact",
    {
      method: "GET",
      params: {
...
export async function AppContactControllerGetContactDetailV1(
  ...
  return request<MyApi.ApiResponseOutputContactDto>(
    `/api/v1/app/contact/${param0}`,
    {
      method: "GET",
      params: { ...queryParams },
      ...(options || {}),
...
export async function AppContactControllerSetDefaultContactV1(
  ...
  return request<MyApi.ApiResponseBoolean>(
    `/api/v1/app/contact/${param0}/set-default`,
    {
      method: "PATCH",
      params: { ...queryParams },
      ...(options || {}),
...
export async function AppContactControllerGetDefaultContactV1(options?: {
  [key: string]: any;
}) {
  return request<MyApi.ApiResponseOutputContactDto>(
    "/api/v1/app/contact/default/current",
    {
      method: "GET",
      ...(options || {}),
    }
