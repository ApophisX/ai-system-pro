...
export async function AppCreditControllerGetAccountV1(
  ...
  return request<MyApi.ApiResponseOutputCreditAccountDto>(
    "/api/v1/app/credit/account",
    {
      method: "GET",
      params: {
        ...params,
...
export async function AppCreditControllerGetRecordsV1(
  ...
  return request<MyApi.ApiResponseOutputCreditRecordDtoArray>(
    "/api/v1/app/credit/records",
    {
      method: "GET",
      params: {
