...
export async function AppAssetControllerCreateAssetV1(
  body: MyApi.CreateAssetDto,
  options?: { [key: string]: any }
) {
...
export async function AppAssetControllerGetAssetDetailV1(
  ...
  return request<MyApi.ApiResponseOutputAssetDetailDto>(
    `/api/v1/app/asset/${param0}`,
    {
      method: "GET",
      params: { ...queryParams },
      ...(options || {}),
...
export async function AppAssetControllerOfflineAssetV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseOutputAssetListItemDto>(
    `/api/v1/app/asset/my/${param0}/offline`,
    {
      method: "POST",
      params: { ...queryParams },
      ...(options || {}),
...
export async function AppAssetControllerPublishAssetV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseOutputAssetListItemDto>(
    `/api/v1/app/asset/my/${param0}/publish`,
    {
      method: "POST",
      params: { ...queryParams },
      ...(options || {}),
...
export async function AppAssetControllerGetCreationStatsV1(options?: {
  [key: string]: any;
}) {
  return request<MyApi.ApiResponseOutputAssetCreationStatsDto>(
    "/api/v1/app/asset/my/creation-stats",
    {
      method: "GET",
      ...(options || {}),
    }
...
export async function AppAssetControllerGetMyAssetsV1(
  ...
  return request<MyApi.ApiResponseOutputMyAssetListItemDtoArray>(
    "/api/v1/app/asset/my/list",
    {
      method: "GET",
      params: {
        // pageSize has a default value: 10
