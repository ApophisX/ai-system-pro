...
export async function AclControllerGetMyPermissionsV1(options?: {
  [key: string]: any;
}) {
...
export async function AclControllerGetMyRolesV1(options?: {
  [key: string]: any;
}) {
...
export async function AclControllerGetPermissionsV1(options?: {
  [key: string]: any;
}) {
...
export async function AclControllerGetRolesV1(options?: {
  [key: string]: any;
}) {
...
export async function AclControllerCreateRoleV1(
  body: MyApi.CreateRoleDto,
  options?: { [key: string]: any }
) {
  return request<MyApi.OutputRoleDto>("/api/v1/acl/roles", {
    method: "POST",
...
export async function AclControllerAssignRoleV1(
  body: MyApi.AssignRoleDto,
  options?: { [key: string]: any }
) {
...
export async function AclControllerRemoveRoleV1(
  body: MyApi.RemoveRoleDto,
  options?: { [key: string]: any }
) {
