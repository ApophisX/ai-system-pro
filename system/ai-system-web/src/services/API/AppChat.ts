...
export async function AppChatControllerGetConversationsV1(
  ...
  return request<MyApi.ApiResponseOutputChatConversationDtoArray>(
...
export async function AppChatControllerGetConversationByIdV1(
  ...
  return request<MyApi.ApiResponseOutputChatConversationDto>(
    `/api/v1/app/chat/conversations/${param0}`,
    {
      method: "GET",
      params: { ...queryParams },
      ...(options || {}),
...
export async function AppChatControllerMarkConversationAsReadV1(
  ...
  return request<MyApi.ApiResponseBoolean>(
    `/api/v1/app/chat/conversations/${param0}/read`,
    {
      method: "PUT",
      params: { ...queryParams },
      ...(options || {}),
...
export async function AppChatControllerGetMessagesV1(
  ...
  return request<MyApi.ApiResponseOutputChatMessageDtoArray>(
    "/api/v1/app/chat/messages",
    {
      method: "GET",
      params: {
        // pageSize has a default value: 10
...
export async function AppChatControllerSendMessageV1(
  ...
  return request<MyApi.ApiResponseOutputChatMessageDto>(
    "/api/v1/app/chat/messages",
    {
      method: "POST",
      headers: {
...
export async function AppChatControllerRecallMessageV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseOutputChatMessageDto>(
    `/api/v1/app/chat/messages/${param0}/recall`,
    {
      method: "PUT",
      params: { ...queryParams },
      ...(options || {}),
...
export async function AppChatControllerGetUnreadCountV1(options?: {
  [key: string]: any;
}) {
