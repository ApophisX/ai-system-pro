...
export async function AppRentalOrderLesseeControllerQueryOrdersV1(
  ...
  return request<MyApi.ApiResponseOutputRentalOrderDto[]>(
    "/api/v1/app/rental-order/lessee",
    {
      method: "GET",
      params: {
...
export async function AppRentalOrderLesseeControllerGetOrderByIdV1(
  ...
  return request<MyApi.ApiResponseOutputRentalOrderDto>(
    `/api/v1/app/rental-order/lessee/${param0}`,
    {
      method: "GET",
      params: { ...queryParams },
      ...(options || {}),
...
export async function AppRentalOrderLesseeControllerCancelOrderV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseOutputRentalOrderDto>(
    `/api/v1/app/rental-order/lessee/${param0}/cancel`,
    {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
...
export async function AppRentalOrderLesseeControllerRevokeCancelOrderV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseOutputRentalOrderDto>(
    `/api/v1/app/rental-order/lessee/${param0}/cancel-cancel`,
    {
      method: "PUT",
      params: { ...queryParams },
      ...(options || {}),
...
export async function AppRentalOrderLesseeControllerConfirmReceiptV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseOutputRentalOrderDto>(
    `/api/v1/app/rental-order/lessee/${param0}/confirm-receipt`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
export async function AppRentalOrderLesseeControllerPayDepositV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseOutputPayDepositResultDto>(
    `/api/v1/app/rental-order/lessee/${param0}/pay-deposit`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
export async function AppRentalOrderLesseeControllerReturnAssetV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseOutputRentalOrderDto>(
    `/api/v1/app/rental-order/lessee/${param0}/return-asset`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
