...
export async function AppFavoriteControllerGetListV1(
  ...
  return request<MyApi.ApiResponseOutputFavoriteDtoArray>(
    "/api/v1/app/favorite",
    {
      method: "GET",
      params: {
...
export async function AppFavoriteControllerCreateV1(
  body: MyApi.CreateFavoriteDto,
  options?: { [key: string]: any }
) {
...
export async function AppFavoriteControllerCheckFavoriteV1(
  ...
  return request<MyApi.ApiResponseBoolean>(
    `/api/v1/app/favorite/check/${param0}`,
    {
      method: "GET",
      params: { ...queryParams },
      ...(options || {}),
...
export async function AppFavoriteControllerGetCountV1(options?: {
  [key: string]: any;
}) {
