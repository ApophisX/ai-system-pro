...
export async function PaymentControllerQueryPaymentsV1(
  ...
  return request<MyApi.ApiResponseOutputPaymentDtoArray>(
    "/api/v1/app/payment",
    {
      method: "GET",
      params: {
...
export async function PaymentControllerGetPaymentByIdV1(
  ...
  return request<MyApi.ApiResponseOutputPaymentDto>(
    `/api/v1/app/payment/${param0}`,
    {
      method: "GET",
      params: { ...queryParams },
      ...(options || {}),
...
export async function PaymentControllerCreateRefundV1(
  body: MyApi.CreateRefundDto,
  options?: { [key: string]: any }
) {
