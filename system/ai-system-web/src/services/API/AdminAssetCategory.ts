...
export async function AdminAssetCategoryControllerGetListV1(
  ...
  return request<MyApi.ApiResponseOutputAssetCategoryDtoArray>(
    "/api/v1/admin/asset-category",
    {
      method: "GET",
      params: {
...
export async function AdminAssetCategoryControllerCreateV1(
  ...
  return request<MyApi.ApiResponseOutputAssetCategoryDetailDto>(
    "/api/v1/admin/asset-category",
    {
      method: "POST",
      headers: {
...
export async function AdminAssetCategoryControllerGetByIdV1(
  ...
  return request<MyApi.ApiResponseOutputAssetCategoryDetailDto>(
    `/api/v1/admin/asset-category/${param0}`,
    {
      method: "GET",
      params: { ...queryParams },
      ...(options || {}),
...
export async function AdminAssetCategoryControllerGetChildrenV1(
  ...
  const { id: param0, ...queryParams } = params;
  return request<MyApi.ApiResponseOutputAssetCategoryDtoArray>(
    `/api/v1/admin/asset-category/${param0}/children`,
    {
      method: "GET",
      params: {
        ...queryParams,
...
export async function AdminAssetCategoryControllerUpdateSortOrderV1(
  body: string[],
  options?: { [key: string]: any }
) {
...
export async function AdminAssetCategoryControllerGetRootsV1(
  ...
  return request<MyApi.ApiResponseOutputAssetCategoryDtoArray>(
    "/api/v1/admin/asset-category/roots",
    {
      method: "GET",
      params: {
        ...params,
...
export async function AdminAssetCategoryControllerGetTreeV1(
  ...
  return request<MyApi.ApiResponseOutputAssetCategoryTreeDtoArray>(
    "/api/v1/admin/asset-category/tree",
    {
      method: "GET",
      params: {
        ...params,
