...
export function PaymentFailureView({
  ...
  // 从 URL 参数或 props 获取跳转链接和错误信息
  const redirectUrl =
    searchParams.get('redirect') || searchParams.get('returnUrl') || defaultRedirectUrl;
  const errorMessage =
    searchParams.get('message') || searchParams.get('error') || '支付失败，请重试';
      ...
      <Container sx={{ py: 4 }}>
        <Stack spacing={4} alignItems="center">
          ...
          >
            ...
            >
              <Iconify icon="solar:danger-triangle-bold" width={80} sx={{ color: 'error.main' }} />
            </Box>
            {/* 外圈动画 */}
            <Box
              component={m.div}
          ...
          {redirectUrl && countdown > 0 && (
            ...
            >
              <Stack direction="row" spacing={1} alignItems="center">
                <CircularProgress size={16} thickness={4} color="error" />
