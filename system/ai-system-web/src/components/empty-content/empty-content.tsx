...
export function ListEmptyContent({
  ...
  return (
    ...
    >
      <EmptyContent {...props} slotProps={slotProps} />
    </Box>
  );
}
  ...
  return (
    <ContentRoot filled={filled} sx={sx} {...other}>
      <Box
        ...
        src={imgUrl ?? `${CONFIG.assetsDir}/assets/icons/empty/ic-folder-empty.svg`}
        {...slotProps?.img}
        sx={[
          {
            width: 1,
      ...
      {description && (
        <Typography
          ...
          sx={[
            { textAlign: 'center', color: 'text.disabled' },
